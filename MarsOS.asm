; download nasm from nasm.us and also install qemu from qemu.org then type in nasm "nasm -f bin .asmFileLoaction
[bits 16]           
[org 0x7c00]        
...
start:              
    ...
    text_label db '  Still In Beta',0

    login_username db 'Username : ',0
    login_password db 'Password : ',0
    

    os_info db 10, 'OS: MarsOS, Bits: 16-Bit, version: =1.2',13,0

    press_key_2 db 10,'Press any key to go to Desktop...',0
    display_text db ' ',0
    window_text db 10,'Desktop', 0
    login_label db '#] Sign Up....(Double Click Enter Key To Skip Sign Up)', 0
